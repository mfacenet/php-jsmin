srcdir = /root/php-jsmin-1.0
builddir = /root/php-jsmin-1.0
top_srcdir = /root/php-jsmin-1.0
top_builddir = /root/php-jsmin-1.0
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = nawk
shared_objects_jsmin = jsmin.lo
PHP_PECL_EXTENSION = jsmin
JSMIN_SHARED_LIBADD =
PHP_MODULES = $(phplibdir)/jsmin.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /root/php-jsmin-1.0/modules
